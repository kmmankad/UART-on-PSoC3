...
/* Rx_Int */
#define Rx_Int__ES2_PATCH 0
#define Rx_Int__INTC_CLR_EN_REG CYREG_INTC_CLR_EN0
#define Rx_Int__INTC_CLR_PD_REG CYREG_INTC_CLR_PD0
#define Rx_Int__INTC_MASK 0x20u
#define Rx_Int__INTC_NUMBER 5
#define Rx_Int__INTC_PRIOR_NUM 7
#define Rx_Int__INTC_PRIOR_REG CYREG_INTC_PRIOR5
#define Rx_Int__INTC_SET_EN_REG CYREG_INTC_SET_EN0
#define Rx_Int__INTC_SET_PD_REG CYREG_INTC_SET_PD0
#define Rx_Int__INTC_VECT (CYREG_INTC_VECT_MBASE+0x0Au)

/* RX */
#define RX__0__MASK 0x01u
#define RX__0__PC CYREG_PRT0_PC0
#define RX__0__PORT 0
